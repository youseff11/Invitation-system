...
register(
    ...
    props=[
        ...
        # سؤال الحضور (سأحضر / أعتذر / غير متأكد). بيتقفل لما الفورم
        # يكون للتهنئة بس أو الحضور معروف مسبقاً. الافتراضي «مفعّل» عشان
        # الدعوات المحفوظة قبل الحقل ده تفضل زي ما هي. الرد اللي بيوصل
        # والسؤال مقفول بيتسجّل «حاضر».
        field("ask_status", "السؤال عن الحضور", "toggle", True, group=RSVP_SETTINGS),
...
SETTINGS_FIELDS = [
    ...
    field("intro_button", "نص الزر", "text", "التالي ←", group="الافتتاحية",
          help_text="الشاشة كلها قابلة للضغط على أي حال — لمسة في أي مكان "
               "بتعمل نفس اللي بيعمله الزر. سيبها فاضية = مفيش زر خالص، "
               "لكن الأحسن تسيبه عشان يبقى واضح للضيف إن فيه حاجة تتضغط."),
    ...
    field("intro_play_mode", "بداية الفيديو", "select", "autoplay",
          ...
          help_text="اختار طريقة بداية فيديو الافتتاحية: التشغيل التلقائي يبدأ "
               ...
               "في وضع الزر، لمسة في أي مكان على الشاشة بتشغّل الفيديو "
               "زي الزر بالظبط."),
